...
export default function EditSilver() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`${API_URl}/getSilverQuantity.php`);
  ...
  const onSilverSubmit = async (e) => {
    ...
    formData.append("silver_quantity", editquantity);
    try {
      const response = await fetch(
        `${API_URl}/editSilverQuan.php`,
        {
          method: "POST",
            ...
            <div className="block overflow-visible">
              <nav>
                ...
                >
                  ...
                  <li
                    role="tab"
                    className={`relative flex items-center justify-center w-full h-full px-2 py-1 font-sans text-base antialiased font-normal leading-relaxed text-center bg-transparent cursor-pointer select-none ${activeTab === "Silver"
                      ? "text-gray-50"
                      : "text-blue-gray-900"
                      }`}
                  ...
                  >
                    ...
                    <div
                      className={`absolute inset-0 z-10 h-full bg-gray-600 rounded-md shadow ${activeTab === "Silver" ? "opacity-100" : "opacity-0"
                        }`}
                      data-projection-id="4"
                    ></div>
                  </li>
              ...
              <div className="relative block w-full overflow-hidden !overflow-x-hidden !overflow-y-visible bg-transparent">
                ...
                >
                  <form className="flex flex-col gap-4 mt-12">
                    ...
                    <div className="my-3">
                      ...
                      <div className="relative h-10 w-full min-w-[200px]">
                        ...
                        <input
                          ...
                          defaultValue={quantity.silver_quantity}
                    ...
                    <button
                      className={`select-none rounded-lg ${activeTab === "Silver" ? "bg-gray-600" : null
