  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setError("Failed to fetch Silver data");
        setLoading(false);
      }
    };
      ...
      <div className="container px-6 py-8 mx-auto">
        ...
        <div className="flex justify-center mt-8">
          <button
            ...
            className="mr-2 px-6 py-1 text-sm rounded-md border border-blue-600 bg-blue-400 text-white hover:bg-blue-600 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-blue-600"
          >
            Previous
          </button>
          ...
          <button
            ...
            className="ml-2 px-6 py-1 text-sm rounded-md border border-blue-300 bg-blue-400 text-white hover:bg-blue-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-blue-600"
          >
            Next
          </button>
        </div>
